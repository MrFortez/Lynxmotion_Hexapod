...
{        
    ...
    if (LegIndex < 3) {
      ...
      //Changing the left femur and tibia code here to be the same as the right legs worked perfectly!!!
      //I can't believe that that was the problem this whole time! Everything works perfectly now 
        wCoxaSSCV = ((long)(sCoxaAngle1 +900))*1000/cPwmDiv+cPFConst;
        //Changed to be the same as right femur
        wFemurSSCV = ((long)(-sFemurAngle1+900))*1000/cPwmDiv+cPFConst;
        //Changed to be the same as right tibia
        wTibiaSSCV = ((long)(-sTibiaAngle1+900))*1000/cPwmDiv+cPFConst;
#ifdef c4DOF
        wTarsSSCV = ((long)(sTarsAngle1+900))*1000/cPwmDiv+cPFConst;
#endif
